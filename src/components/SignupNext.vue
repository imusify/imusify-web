     ...
     <form>
        ...
        <div class="form-group">
           <div class="checkbox long-text">
              <label><input class="checkbox" type="checkbox"/> <span> </span>I acknowledge that I have read and accept the Terms of Use Agreement and consent to the Privacy Policy and Video Privacy Policy.</label>
           </div>
        </div>
        <div class="form-group">
           <div class="checkbox">
              <label><input class="checkbox2" type="checkbox"/> <span></span> Subscribe to our Newsletter</label>
           </div>
        </div>
        <div class="cta left">
